            ...
            <div class="employee-info">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">{{ number_format($savedFullSalary, 2) }} جنيه</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="fas fa-hand-holding-usd"></i> إجمالي السلف</div>
                        <div class="info-value">{{ number_format($savedTotalAdvances, 2) }} جنيه</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label"><i class="fas fa-wallet"></i> الراتب الصافي</div>
                        <div class="info-value">{{ number_format($savedNetSalaryBySalary, 2) }} جنيه</div>
                    </div>
                ...
                <div class="calc-section">
                    ...
                    <div class="calc-grid">
                        <div class="calc-item">
                            ...
                            <div class="calc-value">{{ number_format($savedDailyHours, 2) }} ساعة</div>
                            <div class="calc-formula">{{ $savedMonthlyHours }} ÷ {{ $savedMonthlyDays }}</div>
                        </div>
                        <div class="calc-item">
                            <div class="calc-label">إجمالي الساعات الفعلية</div>
                            <div class="calc-value">{{ number_format($savedActualHours, 2) }} ساعة</div>
                            <div class="calc-formula">{{ $savedDaysWorked }} × {{ number_format($savedDailyHours, 2) }}</div>
                        </div>
                        <div class="calc-item calc-result">
                            <div class="calc-label">المستحقات</div>
                            <div class="calc-value">{{ number_format($savedEntitlementsByHours, 2) }} جنيه</div>
                            <div class="calc-formula">{{ number_format($savedActualHours, 2) }} × {{ $savedHourlyRate }}</div>
                        </div>
                        <div class="calc-item calc-result">
                            <div class="calc-label">الراتب الصافي</div>
                            <div class="calc-value">{{ number_format($savedNetSalaryByHours, 2) }} جنيه</div>
                            <div class="calc-formula">بعد خصم السلف ({{ number_format($savedTotalAdvances, 2) }} جنيه)</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="calc-section">
                    ...
                    <div class="calc-grid">
                        <div class="calc-item">
                            ...
                            <div class="calc-value">{{ number_format($savedFullSalary, 2) }} جنيه</div>
                            <div class="calc-formula">{{ $savedMonthlyHours }} × {{ $savedHourlyRate }}</div>
                        </div>
                        <div class="calc-item">
                            <div class="calc-label">قيمة اليوم الواحد</div>
                            <div class="calc-value">{{ number_format($savedDailySalary, 2) }} جنيه</div>
                            <div class="calc-formula">{{ number_format($savedFullSalary, 2) }} ÷ {{ $savedMonthlyDays }}</div>
                        </div>
                        <div class="calc-item calc-result">
                            <div class="calc-label">المستحقات</div>
                            <div class="calc-value">{{ number_format($savedEntitlementsBySalary, 2) }} جنيه</div>
                            <div class="calc-formula">{{ number_format($savedDailySalary, 2) }} × {{ $savedDaysWorked }}</div>
                        </div>
                        <div class="calc-item calc-result">
                            <div class="calc-label">الراتب الصافي</div>
                            <div class="calc-value">{{ number_format($savedNetSalaryBySalary, 2) }} جنيه</div>
                            <div class="calc-formula">بعد خصم السلف ({{ number_format($savedTotalAdvances, 2) }} جنيه)</div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($advance->paid_amount, 2) }} جنيه</td>
                                    <td>{{ number_format($advance->amount - $advance->paid_amount, 2) }} جنيه</td>
                                    <td>
