                            ...
                            <tbody>
                                @forelse($employees ?? [] as $employee)
                                    <tr>
                                        ...
                                        <td>{{ $employee->monthly_salary ? number_format(round($employee->monthly_salary), 0, '.', ',') : '0' }} جنيه</td>
                    <td class="text-danger">{{ number_format($employee->total_remaining_advances, 0, '.', ',') }} جنيه</td>
                    <td class="text-success fw-bold">{{ number_format(round($employee->net_salary), 0, '.', ',') }} جنيه</td>
